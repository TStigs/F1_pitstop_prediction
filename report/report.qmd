...
The final test predictions were generated using our weighted probability ensemble across the 188,165 test rows:
- **Output File**: `submissions/submission.csv`
- **Verification**: Exactly 188,165 rows, columns `['id', 'PitNextLap']`, 0 missing or NaN values.
